...
# gnome-terminal --tab --title="KINOVA MOVEIT" --command "bash -c \"source ~/.bashrc; roslaunch j2n6s300_moveit_config j2n6s300_demo.launch; exec bash\"";
gnome-terminal --tab --title="KINOVA MOVEIT" --command "bash -c \"source ~/.bashrc; roslaunch testbed_small j2n6s300_moveit_demo.launch; exec bash\"";
